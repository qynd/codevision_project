...
class DirectorExpenseListScreen extends StatefulWidget {
  const DirectorExpenseListScreen({super.key});

  @override
  State<DirectorExpenseListScreen> createState() => _DirectorExpenseListScreenState();
}

class _DirectorExpenseListScreenState extends State<DirectorExpenseListScreen> {
  ...
  Future<void> _fetchExpenses() async {
    ...
    try {
      ...
      debugPrint("Error fetching director expenses: $e");
      if (mounted) {
            ...
            : _expenses.isEmpty
                ? ListView(
                    children: [
                      ...
                      const Center(
                        child: Text("Belum ada data pengajuan dana.",
